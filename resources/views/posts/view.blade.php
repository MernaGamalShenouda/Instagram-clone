                        ...
                        <div class="post-userInfo-content">
                            <div>
                                <p class=""><strong class="me-1">{{ $post->user->username }}:</strong>
                                    {!! preg_replace(
                                        '/#(\w+)/',
                                        '<a href="javascript:void(0);" onclick="redirectToTagView(\'$1\')">#$1</a>',
                                        $post->content,
                                    ) !!}
                                </p>
                            </div>
                ...
                <div class="border col-md-12 post-likes-section d-flex flex-column align-items-center">
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <div class="d-flex align-items-center">
                            <!-- Heart icon -->
                            <form id="like-form" action="{{ route('post.create-like') }}" method="post"
                ...
                <div class="col-md-12 post-input-section">
                    <form method="POST" action="{{ route('posts.storeComment') }}" id='commentForm'>
                        ...
                        <div class="input-group border">
                            ...
                            <input type="text" class="form-control border-0" name="content"
                                placeholder="Add a comment...">
                            <input type="text" class="form-control border-0" name="username" hidden
                                value="{{ $user->username }}">
