...
<div class="min-h-screen flex flex-col sm:justify-center items-center pt-2 sm:pt-0 ">
        ...
        <div class="text-center">
            <p class="text-lg text-gray-500 font-bold mb-4 ">Sign up to see photos and videos from your friends.</p>
        </div>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required placeholder="Email or Mobile Number" autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="full_name" class="block mt-1 w-full" type="text" name="full_name" :value="old('full_name')" required placeholder="Full Name" autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="username" class="block mt-1 w-full" type="text" name="username" :value="old('username')" required placeholder="Username" autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            type="password"
            name="password_confirmation" required placeholder="Re-enter Password" autocomplete="new-password" />
        ...
        <div class="mt-4 mb-4">
            ...
            <x-text-input id="gender" class="block mt-1 w-full" type="text" name="gender" :value="old('gender')" required placeholder="Gender" autocomplete="gender" />
        ...
        <!-- <div class="mt-4">
            ...
            <x-text-input id="image" class="block mt-1 w-full" type="text" name="image" :value="old('image')" autocomplete="image" />
        ...
        <!-- <div class="mt-4">
            ...
            <x-text-input id="avatar" class="block mt-1 w-full" type="text" name="avatar" :value="old('avatar')" autocomplete="avatar" />
            <x-input-error :messages="$errors->get('avatar')" class="mt-2" />
        </div> -->
        
        
        <div class="mb-8">
            <p class="text-sm mb-2 text-gray-600 text-center">
                People who use our service may have uploaded your contact information to Instagram. <a class="font-bold text-blue-500 hover:text-blue-700" href="https://www.facebook.com/help/instagram">Learn More</a>
                    </p>
                ...
                <div class="mb-8">
                    <p class="text-sm mb-2 text-gray-600 text-center">
                        By signing up, you agree to our <a class="font-bold text-blue-500 hover:text-blue-700" href="https://help.instagram.com/581066165581870/?helpref=uf_share">Terms</a>, <a class="font-bold text-blue-500 hover:text-blue-700" href="https://privacycenter.instagram.com/policy">Privacy Policy</a>, and <a class="font-bold text-blue-500 hover:text-blue-700" href="https://privacycenter.instagram.com/policies/cookies/">Cookies Policy</a>.
                    </p>
                    <input class="block w-full p-2 bg-blue-500 text-white rounded-lg cursor-pointer" type="submit" value="Sign up">
                </div>
                ...
                <div class="w-full sm:max-w-md mt-6  px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg flex items-center justify-center ">
                    ...
                    <a class=" text-blue-600 font-bold py-2 px-4" href="{{ route('login') }}">Log in</a>
                </div>
            </form>
        </div>
    </div>
